...
mod tests {
    use super::{
        ...
        inspect_wikilinks, normalize_front_matter_timestamps, restore_note,
        rewrite_wikilink_targets, split_note_source, stamp_note_created_at, stamp_note_updated_at,
