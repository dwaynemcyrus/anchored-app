...
Anchored `0.1.2-alpha` is available as a private Intel Mac alpha for in-house
testing.
...
Open `Anchored_0.1.2-alpha_x64.dmg`, drag **Anchored** into **Applications**, eject
...
version greater than the installed version. The current updater-enabled release
is `v0.1.2-alpha`.
